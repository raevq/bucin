  ...
  <div :class="darkMode() ? 'darkBG' : 'lightBG'">
    ...
    <div class="main">
      ...
      <vue-typed-js
        ...
        :showCursor="false"
        :loop="true"
        :strings="[greetings() + ', ' + nicknames + '! ^2500', 'Semoga panjang umur' ^2000, 'dan sehat selalu ^2000', 'Tercapai semua yang diinginkan ^2000', 
        'Semangat ngajarnya!! ^2000', 'Semangat mencari korporatnya! ^2000','Semangat semuanya^2000','Aku sayang kamuu ^2000','Love U <333 ^2500']"
        :backDelay="500"
        :typeSpeed="100"
        :backSpeed="20"
        :contentType="'null'"
