  ...
  <div :class="darkMode() ? 'darkBG' : 'lightBG'">
    ...
    <div class="main">
      ...
      <vue-typed-js
        ...
        :showCursor="false"
        :loop="true"
        :strings="[greetings() + ', ' + nicknames + '! ^2500', 'Semoga panjang umur dan sehat selalu :) ^2000', 'Tercapai semua yang diinginkan juga! ^2000', 'Semangat ngajarnya!! ^2000', 'Jadi adminnya juga semangatt!! ^2000','Kevin sayang kamuu <33 ^2000','Love U <333 ^2500']"
        :backDelay="500"
        :typeSpeed="100"
        :backSpeed="20"
        :contentType="'null'"
